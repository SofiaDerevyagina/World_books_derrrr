...
class Book (models.Model):
    ...
    genre = models.ForeignKey('Genre', on_delete=models.CASCADE, help_text="Введите жанр книги", verbose_name="Жанр книги")
    language = models.ForeignKey('Language', on_delete=models.CASCADE, help_text="Введите язык книги", verbose_name="Язык книги")
    author = models.ManyToManyField('Author', help_text="Выберите автора книги", verbose_name="Автор книги")
    summary = models.TextField(max_length=1000, help_text="Выберите краткое описание книги", verbose_name="Аннотация книги")
    isbn = models.CharField(max_length=13, help_text="Максимум 13 символов", verbose_name="ISBN книги")
