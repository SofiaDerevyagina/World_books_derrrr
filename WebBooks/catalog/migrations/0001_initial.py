# Generated by Django 4.1.5 on 2023-02-06 09:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('summary', models.TextField(help_text='Выберите краткое описание книги', max_length=1000, verbose_name='Аннотация книги')),
                ('isbn', models.CharField(help_text='Максимум 13 символов', max_length=13, verbose_name='ISBN книги')),
        ...
        migrations.AddField(
            model_name='book',
            name='genre',
            field=models.ForeignKey(help_text='Введите жанр книги', on_delete=django.db.models.deletion.CASCADE, to='catalog.genre', verbose_name='Жанр книги'),
        ),
        migrations.AddField(
            model_name='book',
            name='language',
            field=models.ForeignKey(help_text='Введите язык книги', on_delete=django.db.models.deletion.CASCADE, to='catalog.language', verbose_name='Язык книги'),
        ),
    ]
